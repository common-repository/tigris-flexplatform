...
?>
<!-- Default template from Plug-In form-tigrisresume.php: BEGIN -->
<form method="post" class="vacancy-form" enctype="multipart/form-data">
	...
	<div>
		<button
			type="submit"
			id="send-form"
			class="x-btn-tigris-send resume-btn-tigris-send"
...
<!-- Default template from Plug-In form-tigrisresume.php: END -->